...
/** Below Added From CharacterCreation found in Content/Characters**/
...
ReplaceConverted="/Game/SirenGameMode.SirenGameMode_C", OverrideNativeName="SirenGameMode_C"))// edited from Character Creation
...
GENERATED_BODY()
	...
	AGameModeBase_C__pf4110416193(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_SirenGameMode__pf_0(int32 bpp__EntryPoint__pf);
